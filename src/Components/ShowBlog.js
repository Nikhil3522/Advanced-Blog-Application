...
const ShowBlog = () => {
    ...
    useEffect(() => {
        var temp = sessionStorage.getItem('blog');
   ...
   return (
    // <div className=" bg-pink-300">
        <div className=" flex flex-col w-[700px] m-[auto]">
            {sessionBlogList ?
            sessionBlogList.map(({title, content, thumbnail, author, index}) => (
                    <div key={index+4} className="flex flex-col mt-20  border-2 p-4 bg-slate-100 shadow-md rounded-xl hover:shadow-lg hover:cursor-pointer">
